...
$(document).on('click', '.clothing-menu-header-camera-btn2', function(e) {
    e.preventDefault();
...
$(document).on('click', '.clothing-menu-header-camera-btn3', function(e) {
    e.preventDefault();
...
$(document).on('click', '.clothing-menu-header-camera-btn4', function(e) {
    e.preventDefault();
...
QBClothing.Open = function(data) {
    ...
    $(".left-box").css({ "display": "block" }).animate({ left: 0, }, 200);
    ...
    $.each(data.menus, function(i, menu) {
        if (menu.selected) {
            $(".clothing-menu-header").append('<div class="clothing-menu-header-btn ' + menu.menu + 'Tab selectedd" data-category="' + menu.menu + '"><p>' + menu.label + '</p></div>')
...
QBClothing.Close = function() {
    ...
    $(".left-box").css({ "display": "block" }).animate({ left: "-25vw", }, 200, function() {
...
QBClothing.ResetValues = function() {
    $.each(clothingCategorys, function(i, cat) {
        var itemCats = $(".clothing-menu-container").find('[data-type="' + i + '"]');
        var itemCats = $(".left-box").find('[data-type="' + i + '"]');
        var input = $(itemCats).find('input[data-type="item"]');
        var texture = $(itemCats).find('input[data-type="texture"]');
